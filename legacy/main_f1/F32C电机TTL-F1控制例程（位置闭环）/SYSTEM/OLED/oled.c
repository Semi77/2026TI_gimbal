...
void  OLED_Show(void)
{
	...
	if(F32C_Motor1.target_position>0)
	{
		OLED_ShowString(15,0,"+");
	    OLED_ShowNumber(25,0,F32C_Motor1.target_position,6,12);
	}
	else
	{
		OLED_ShowString(15,0,"-");
		OLED_ShowNumber(25,0,abs(F32C_Motor1.target_position),6,12);
	}
	OLED_ShowString(60,0,"C:");
	if(F32C_Motor1.current_position>0)
	{
		OLED_ShowString(75,0,"+");
	    OLED_ShowNumber(85,0,F32C_Motor1.current_position,6,12);
	}
	else
	{
		OLED_ShowString(75,0,"-");
		OLED_ShowNumber(85,0,abs(F32C_Motor1.current_position),6,12);
	}
	OLED_ShowString(0,10,"T:");
    if(F32C_Motor2.target_position>0)
	{
	  OLED_ShowString(15,10,"+");
	  OLED_ShowNumber(25,10,F32C_Motor2.target_position,6,12);
	}
	else
	{
		OLED_ShowString(10,10,"-");
		OLED_ShowNumber(25,10,abs(F32C_Motor2.target_position),6,12);
	}
	OLED_ShowString(60,10,"C:");
	if(F32C_Motor2.current_position>0)
	{
		OLED_ShowString(75,10,"+");
	    OLED_ShowNumber(85,10,F32C_Motor2.current_position,6,12);
	}
	else
	{
		OLED_ShowString(75,10,"-");
		OLED_ShowNumber(85,10,abs(F32C_Motor2.current_position),6,12);
	}
	if(Vision_Data_Ready)
	{
		OLED_ShowString(0,20,"VX:");
		OLED_ShowNumber(20,20,Vision_X,4,12);
		OLED_ShowString(64,20,"VY:");
		OLED_ShowNumber(84,20,Vision_Y,4,12);
		OLED_ShowString(0,30,"VISION:OK");
	}
	else
	{
		OLED_ShowString(0,20,"VX:----");
		OLED_ShowString(64,20,"VY:----");
		OLED_ShowString(0,30,"VISION:WAIT");
	}
}	
